...
const TECH = [
  "Java", "Swing", "POO", "Physics Simulation", "Algorithms",
];

// 4 imágenes — formato horizontal tipo "feature showcase"
const IMAGES = [
  { src: "https://picsum.photos/seed/therm1/900/600", alt: "Simulador — vista general", label: "Vista general" },
  { src: "https://picsum.photos/seed/therm2/900/600", alt: "Gráfica PV", label: "Diagrama P-V" },
  { src: "https://picsum.photos/seed/therm3/900/600", alt: "Partículas en movimiento", label: "Partículas" },
  { src: "https://picsum.photos/seed/therm4/900/600", alt: "Panel de control", label: "Controles" },
];

// Stats del simulador
const STATS = [
  { value: "3", label: "Procesos\ntermodinámicos" },
  { value: "60fps", label: "Render de\npartículas" },
  { value: "N→∞", label: "Partículas\nsimuladas" },
  { value: "Java", label: "Lenguaje\nprincipal" },
];
  ...
  return (
    <div id="project-thermo">
      <ProjectHero
        ...
        description="Simulaciones termodinámicas con representación visual de variables físicas y comportamiento de partículas. Procesos isotérmico, adiabático e isocórico interactivos."
        color={COLOR}
        url="#"
        repo="#"
      />
      ...
      <ProjectInfo
        color={COLOR}
        what="Visualizar procesos termodinámicos de forma interactiva para facilitar la comprensión de conceptos físicos como la ley de los gases ideales."
        how="Java Swing para interfaz gráfica, algoritmos de simulación de partículas basados en ecuaciones de estado, renderizado frame a frame con control de variables."
        result="Simulador funcional que representa visualmente el comportamiento de partículas bajo condiciones termodinámicas distintas con controles en tiempo real."
      />
